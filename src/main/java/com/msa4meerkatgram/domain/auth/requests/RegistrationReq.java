...
public record RegistrationReq(
        ...
        @Schema(description = "비밀번호 체크", example = "qwer1234", nullable = false, requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank(message = "비밀번호 체크는 필수 항목입니다.")
        String passwordChk,

        @Schema(description = "닉네임 체크", example = "chozza", nullable = false, requiredMode = Schema.RequiredMode.REQUIRED)
