...
//        String extractRefreshToken = refreshTokenOptional.get();
    ...
    public void  registration(RegistrationReq registrationReq){
        // 유저 정보 획득
//        authRepository.findByEmail(registrationReq.email()).ifPresent(user -> {throw new DuplicatedRecordException("이미 가입된 회원입니다.");});
